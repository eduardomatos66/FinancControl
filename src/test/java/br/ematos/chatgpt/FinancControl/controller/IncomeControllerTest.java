...
public class IncomeControllerTest {
  ...
  void testFindByDate() throws Exception {
    ...
    List<IncomeEntity> expectedIncomeEntities = Collections.singletonList(new IncomeEntity(1, date, "From Who", "Comment", 100L, true));
    ...
    stubFor(get(urlEqualTo("/externalAPI?date=" + dateString))
    ...
    mockMvc.perform(MockMvcRequestBuilders.get(BASE_URL + "/date/" + dateString))
            .andExpect(MockMvcResultMatchers.status().isOk())
            .andExpect(MockMvcResultMatchers.content().json(objectMapper.writeValueAsString(expectedIncomeEntities)))
