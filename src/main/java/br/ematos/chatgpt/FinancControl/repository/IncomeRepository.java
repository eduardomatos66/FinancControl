...
public interface IncomeRepository extends JpaRepository<IncomeEntity, Integer> {
    ...
    @Modifying
    @Query("UPDATE IncomeEntity i SET i.date = :date, i.fromWho = :fromWho, i.comment = :comment, i.value = :value, i.isRealized = :isRealized WHERE i.id = :id")
    void updateIncome(@Param("id") Integer id, @Param("date") Date date, @Param("fromWho") String fromWho, @Param("comment") String comment, @Param("value") Long value, @Param("isRealized") Boolean isRealized);
}